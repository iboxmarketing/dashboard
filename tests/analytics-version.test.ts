...
test("2: analyticsVersion 14 joriy, 13 esa kanonik sotuvchi maydonisiz eskirgan", () => {
...
test("3: yangi qurilgan yozuvlar 14-versiya bilan saqlanadi", () => {
  assert.equal(record().analyticsVersion, 14);

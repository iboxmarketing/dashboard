...
export const D1_WRITE_AUDIT_POINTS = Object.freeze({
  ...
  RAW_STAGE_HISTORY_INSERT: point({ table: "raw_stage_history", operation: "insert_or_replace" }),
  RAW_STAGE_HISTORY_DELETE: point({ table: "raw_stage_history", operation: "delete" }),
